...
Sub-issue leaf for repo-b in the LOC-29 tiny multi-repo sub-issue
...
- Demonstrate the leaf-with-exact-repo contract for a second repo.
...
- One sub-issue leaf task with `repo: repo-b`.
